            ...
            <div className="flex gap-2">
              {prevLessonDocId ? (
                <Button
                  ...
                  render={
                    <Link
                      href={`/dashboard/student/courses/${courseId}/lessons/${prevLessonDocId}`}
                    >
                ...
                <Button
                  variant="outline"
                  size="sm"
                  className="flex-1 text-xs opacity-30"
                  disabled
                >
                  <ArrowLeftIcon className="h-3.5 w-3.5" />
                  আগেরটা
              ...
              {nextLessonDocId ? (
                isNextLocked ? (
                  <Button
                    variant="outline"
                    size="sm"
                    className="flex-1 gap-1 text-xs opacity-50"
                    disabled
                  >
                    পরেরটা
                  ...
                  <Button
                    ...
                    render={
                      <Link
                        href={`/dashboard/student/courses/${courseId}/lessons/${nextLessonDocId}`}
                      >
                        পরেরটা
